...
export const services: ServiceItem[] = [
  {
    id: 'srv-1',
    title: { ua: 'Воскресне служіння', ru: 'Воскресное служение', en: 'Sunday Service', nl: 'Zondagsdienst', es: 'Servicio Dominical' },
  ...
  {
    id: 'srv-2',
    title: { ua: 'Молодіжне служіння', ru: 'Молодёжное служение', en: 'Youth Service', nl: 'Jeugddienst', es: 'Servicio de Jóvenes' },
    day: { ua: 'Субота', ru: 'Суббота', en: 'Saturday', nl: 'Zaterdag', es: 'Sábado' },
    time: '18:30',
    address: 'Javastraat 118, Amsterdam',
    type: 'youth',
    brandName: 'EMMANUIL\nYOUTH',
...
export const homeGroups: ServiceItem[] = [
  {
    id: 'hg-1',
    title: { ua: 'Домашня група', ru: 'Домашняя группа', en: 'Home Group', nl: 'Huisgroep', es: 'Grupo Familiar' },
    ...
    description: {
      ...
      nl: 'Goed bereikbaar voor mensen in Amsterdam — makkelijk per fiets, metro of tram. Gebruik je navigatie-app!',
      es: 'Accesible para quienes viven en Ámsterdam — fácil llegar en bicicleta, metro o tranvía. ¡Usa tu app de navegación!',
    },
  ...
  },
  {
    ...
    description: {
      ...
      nl: 'Gelegen bij Utrecht. Openbaar vervoer is lastig — geen directe trein of bus. Het beste per auto, zoek iemand die dezelfde kant op gaat!',
      es: 'Ubicado cerca de Utrecht. El transporte público es difícil — no hay tren ni autobús directo. Mejor en coche, ¡busca a alguien que vaya en esa dirección!',
    },
  ...
  },
  {
    id: 'hg-3',
    title: { ua: 'Домашня група', ru: 'Домашняя группа', en: 'Home Group', nl: 'Huisgroep', es: 'Grupo Familiar' },
    day: { ua: 'Четвер', ru: 'Четверг', en: 'Thursday', nl: 'Donderdag', es: 'Jueves' },
    time: '19:00',
    ...
    description: {
      ...
      nl: 'Gelegen op 1 minuut van station Almere Centrum. Ga naar binnen via de hoofdingang van het Best Western Plus (Plaza Premium) hotel en neem de lift naar de 15e verdieping!',
      es: 'A 1 minuto de la estación central de Almere. Entra por la entrada principal del hotel Best Western Plus (Plaza Premium) y sube en el ascensor al piso 15.',
    },
    photo: 'https://i.ibb.co/7dVpTK3V/image.jpg',
  },
  {
    id: 'hg-4',
    title: { ua: 'Домашня група', ru: 'Домашняя группа', en: 'Home Group', nl: 'Huisgroep', es: 'Grupo Familiar' },
